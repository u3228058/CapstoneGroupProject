...
from wc_model import best_model
...
class WC_GUI:
    def __init__(self):
        ...
        self.depth_label = tk.Label(self.four_frame, text='Depth (km):')
        ...
        self.button_predict = tk.Button(self.ninth_frame, text='Predict MMI', command=self.predict_MMI)
